 ...
 * @author Lynford
 */
public class CandidateSearchResultForm extends javax.swing.JFrame {

     public Connection con;
    public Statement st;
    /**
     * Creates new form CandidateSearchResultForm
     */
    public CandidateSearchResultForm() {
        initComponents();
    }

    CandidateSearchResultForm(String search) {
        initComponents();
        ...
        search_result_list_of_candidates(search);
   ...
   /**
     ...
     */
    public ArrayList<Voters> getSearchCandidateList(String sid){
        ...
        try{
            ...
            String query = "SELECT * FROM voters WHERE student_id = '"+sid+"'";
    ...
    public void search_result_list_of_candidates(String sid){
        ...
        ArrayList<Voters>list = getSearchCandidateList(sid);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Candidate Search Result");
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        new ListOfCandidatesForm().setVisible(true);
         ...
         new CandidateSearchResultForm().setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CandidateSearchResultForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CandidateSearchResultForm().setVisible(true);
            }
        });
    }
